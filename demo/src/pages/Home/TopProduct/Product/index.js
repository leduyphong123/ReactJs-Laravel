...
class Product extends React.Component {
    ...
    componentDidMount() {
        fetch("http://127.0.0.1:8000/api/topProducts", {
            "method": "get"
        })
...
//     return (
//         <div className='grid grid-flow-row grid-cols-2 gap-2 px-2 md:grid-cols-5'>
...
//                 </div>
//             </div>
//             <div className='md:hidden bg-white pb-1 shadow-xl rounded-md relative hover:border-pink-500 hover:border hover:pb-0 hover:cursor-pointer'>
//                 <div className="absolute bg-pink-500 text-white px-3 py-1 rounded-full top-2 left-2 text-xs md:text-sm md:px-4">50%</div>
//                 <img src={imgCategory[0]} className="w-full rounded-md" />
//                 <div className='px-2 flex flex-col relative h-[68px]'>
//                     <h4 className='text-base'>Name Product</h4>
